    ...
    Word Guesser Qmyks
    ==================
    Lightweight mini-game playable entirely in the Python interactive shell.
...
return {"score": score, "rounds": guessed_in, "won": score > 0}
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight mini-game playable entirely in the Python interactive shell.")
